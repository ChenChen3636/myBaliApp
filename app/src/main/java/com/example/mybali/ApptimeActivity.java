...
public class ApptimeActivity extends AppCompatActivity {
    ...
    Button enableBtn, showBtn ,btnBackHome;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_apptime);
        ...
        btnBackHome = findViewById(R.id.btn_appIntentBackToHome);
    ...
    public void setBackHomeBtn(){
        btnBackHome.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.setClass(ApptimeActivity.this,MainActivity.class);
