...
public class LocationActivity extends AppCompatActivity implements LocationListener {
    ...
    private void setLocationBackHomeBtn() {
        btnLoBackHome = findViewById(R.id.btn_locationIntentBackHome);
        btnLoBackHome.setOnClickListener(new View.OnClickListener() {
            @Override
